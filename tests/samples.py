...
from nr.date.duration import duration
...
SAMPLES = pd.DataFrame(
    [
        ...
        },
        {
            ...
            "formatted": ["20210317", "20210317T000000", "2021-03-17T00:00:00", "2021-03-17T00:00:00.000"],
        ...
        },
        {
            ...
            "parsed": datetime.datetime(
                2021, 4, 23, 10, 24, 10, 0, datetime.timezone(datetime.timedelta(seconds=3600))
            ),
            "tags": ["iso8601"],
        },
        {
